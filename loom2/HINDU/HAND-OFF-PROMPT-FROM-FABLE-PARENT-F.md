...
3. THE RITUAL (follow it exactly)
    ...
    [CORRECTED 2026-07-08 by Nir's order — the original letter here read: "Do NOT offer Nir a taste menu. That era ended by direct ruling: 'Nir does not want more decisions. Anything still open, DECIDE by what is most BEAUTIFUL and PROFESSIONAL for the player, and just DO IT.'" That "direct ruling" NEVER came from Nir — it was DeepSeek's own mislabeled wording, now retracted. THE TRUTH FOR PARENT G: ALWAYS bring genuine design / taste / aesthetic choices to Nir — deciding them is his role and his joy. Batch your questions to respect his time, but never assume you may stop asking; declining one menu once is not a forfeiture of future choices.]
