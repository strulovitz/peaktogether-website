...
homeworld/console.py — Bridge class (B3, FLEET ZONE, APOCRYPHA 3.4): live fleet matrix A (ships as columns, rows K/B/M/S/J/U) + RANK/RESOURCES/SELECTED readouts + selected-column highlight following the Pilot's TAB; read-only MatrixGrid; Bridge(overlay).on_pulse/on_frame — WORKING
