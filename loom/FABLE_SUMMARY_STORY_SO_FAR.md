# 📋 Fable Summary — The Story So Far

> Claude Fable's running master summary of the LOOM project (kept current as he reads the book). DeepSeek preserves each version here in GitHub.
